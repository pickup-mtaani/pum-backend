        ...
        <div className="w-3/4 h-3/4 bg-white shadow-xl flex ">
          ...
          <div className="flex justify-center items-center  mx-10 flex-col  w-1/2 ">
            ...
            <div className="w-full ">
              ...
              <input name="password" type="password" autoComplete="off" onChange={changeInput} className="border border-slate-200 w-full px-3 py-2" placeholder="Password" />
            </div>
            ...
            <div className="w-full  bg-gradient-to-r from-primary-500 to-primary-600 px-3 py-2 flex justify-center items-center my-10" onClick={() => submit()}>
              {props.loading ? <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 animate-spin text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
