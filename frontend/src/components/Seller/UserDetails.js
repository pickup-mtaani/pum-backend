...
function UserDetails(props) {
    ...
    let Tabs = [
        {
            name: "Business",
            component: (<Bussiness fetchProducts={fetchProducts} />),
...
export default connect(mapStateToProps, { get_seller_bussiness, get_seller_products, get_all_products })(UserDetails);
